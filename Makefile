...
MODULES=ast type idesupport lexer vfs common genxml parser typecore optimizer typeload \
...
common.$(MODULE_EXT): idesupport.$(MODULE_EXT) vfs.$(MODULE_EXT) type.$(MODULE_EXT) ast.$(MODULE_EXT) libs/ilib/il.$(LIB_EXT)
...
idesupport.$(MODULE_EXT): type.$(MODULE_EXT)
...
typer.$(MODULE_EXT): typeload.$(MODULE_EXT) typecore.$(MODULE_EXT) type.$(MODULE_EXT) idesupport.$(MODULE_EXT) parser.$(MODULE_EXT) optimizer.$(MODULE_EXT) lexer.$(MODULE_EXT) interp.$(MODULE_EXT) genneko.$(MODULE_EXT) genjs.$(MODULE_EXT) common.$(MODULE_EXT) codegen.$(MODULE_EXT) ast.$(MODULE_EXT) filters.$(MODULE_EXT) gencommon.$(MODULE_EXT)
